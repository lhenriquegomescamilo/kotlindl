...
public class AdaGrad(
    ...
    private lateinit var initialAccumulatorValueConstant: Constant<TFloat32>
    ...
    override fun applyGradients(
        ...
        initialAccumulatorValueConstant = tf.constant(initialAccumulatorValue)
        ...
        for (i in weights.indices) {
            ...
            val slot: Variable<TFloat32> = getSlot(varName, ACCUMULATOR)
    ...
    private fun createAdaGradSlot(graph: KGraph, tf: Ops, v: Output<TFloat32>) {
        val accumInitializerName = defaultInitializerOpName(createName(v, ACCUMULATOR))

        val initializer: Operand<TFloat32> = tf.withName(accumInitializerName)
